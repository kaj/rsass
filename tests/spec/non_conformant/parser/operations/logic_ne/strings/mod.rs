//! Tests auto-converted from "sass-spec/spec/non_conformant/parser/operations/logic_ne/strings"
#[allow(unused)]
use super::rsass;

// From "sass-spec/spec/non_conformant/parser/operations/logic_ne/strings/pairs.hrx"
#[test]
fn pairs() {
    assert_eq!(
        rsass(
