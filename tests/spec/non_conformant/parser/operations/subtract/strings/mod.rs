//! Tests auto-converted from "sass-spec/spec/non_conformant/parser/operations/subtract/strings"
#[allow(unused)]
use super::rsass;

// From "sass-spec/spec/non_conformant/parser/operations/subtract/strings/pairs.hrx"
#[test]
#[ignore] // wrong result
fn pairs() {
    assert_eq!(
