//! Tests auto-converted from "sass-spec/spec/non_conformant/parser/operations/logic_eq/dimensions"
#[allow(unused)]
use super::rsass;

// From "sass-spec/spec/non_conformant/parser/operations/logic_eq/dimensions/pairs.hrx"
#[test]
fn pairs() {
    assert_eq!(
        rsass(
