//! Tests auto-converted from "sass-spec/spec/non_conformant/parser/operations/addition/strings"
#[allow(unused)]
use super::rsass;

// From "sass-spec/spec/non_conformant/parser/operations/addition/strings/pairs.hrx"
#[test]
fn pairs() {
    assert_eq!(
        rsass(
