//! Tests auto-converted from "sass-spec/spec/non_conformant/scss/media"
#[allow(unused)]
use super::rsass;

// From "sass-spec/spec/non_conformant/scss/media/interpolated.hrx"
#[test]
fn interpolated() {
    assert_eq!(
        rsass(
...
// From "sass-spec/spec/non_conformant/scss/media/script_features.hrx"
#[test]
fn script_features() {
    assert_eq!(
        rsass(
