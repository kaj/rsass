//! Tests auto-converted from "sass-spec/spec/values/calculation/calc/error/known_incompatible/length/pc.hrx"

#[allow(unused)]
fn runner() -> crate::TestRunner {
    super::runner().with_cwd("pc")
}

#[test]
fn deg() {
    assert_eq!(
        runner().err("a {b: calc(1pc + 1deg)}\n"),
