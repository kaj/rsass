//! Tests auto-converted from "sass-spec/spec/core_functions/color/change_color/error"
#[allow(unused)]
use super::rsass;

// From "sass-spec/spec/core_functions/color/change_color/error/args.hrx"
mod args {
    #[allow(unused)]
    use super::rsass;
    ...
    // Ignoring "unknown", error tests are not supported yet.
}

// From "sass-spec/spec/core_functions/color/change_color/error/bounds.hrx"
mod bounds {
    #[allow(unused)]
    use super::rsass;
    mod alpha {
...
// From "sass-spec/spec/core_functions/color/change_color/error/mixed_formats.hrx"
mod mixed_formats {
    #[allow(unused)]
    use super::rsass;

    // Ignoring "blue_and_lightness", error tests are not supported yet.
    ...
    // Ignoring "red_and_hue", error tests are not supported yet.

    // Ignoring "saturation_and_blackness", error tests are not supported yet.
}

// From "sass-spec/spec/core_functions/color/change_color/error/type.hrx"
mod test_type {
    #[allow(unused)]
    use super::rsass;
...
// From "sass-spec/spec/core_functions/color/change_color/error/units.hrx"
mod units {
    #[allow(unused)]
    use super::rsass;
    mod none {
