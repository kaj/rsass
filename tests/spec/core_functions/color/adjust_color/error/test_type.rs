...
fn alpha() {
    assert_eq!(
        runner().err("a {b: adjust-color(red, $alpha: c)}\n"),
...
fn blackness() {
    assert_eq!(
        runner().err("a {b: adjust-color(red, $blackness: c)}\n"),
...
fn blue() {
    assert_eq!(
        runner().err("a {b: adjust-color(red, $blue: c)}\n"),
...
fn green() {
    assert_eq!(
        runner().err("a {b: adjust-color(red, $green: c)}\n"),
...
fn hue() {
    assert_eq!(
        runner().err("a {b: adjust-color(red, $hue: c)}\n"),
...
fn lightness() {
    assert_eq!(
        runner().err("a {b: adjust-color(red, $lightness: c)}\n"),
...
fn red() {
    assert_eq!(
        runner().err("a {b: adjust-color(red, $red: c)}\n"),
...
fn saturation() {
    assert_eq!(
        runner().err("a {b: adjust-color(red, $saturation: c)}\n"),
...
fn whiteness() {
    assert_eq!(
        runner().err("a {b: adjust-color(red, $whiteness: c)}\n"),
