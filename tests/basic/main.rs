...
#[test]
fn t01_simple_css() -> Result<(), String> {
    assert_eq!(rsass("a {\n  color: blue;\n}")?, "a {\n  color: blue;\n}\n");
    Ok(())
}
...
#[test]
fn t02_simple_nesting() -> Result<(), String> {
    assert_eq!(
        rsass("div {\n  img {\n    border: 0px;\n  }\n}")?,
        "div img {\n  border: 0px;\n}\n"
    );
...
#[test]
fn t03_simple_variable() -> Result<(), String> {
    assert_eq!(
        rsass("$color: red;\n\na {\n  color: $color;\n}")?,
        "a {\n  color: red;\n}\n"
    );
...
#[test]
fn t04_basic_variables() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t05_empty_levels() -> Result<(), String> {
    assert_eq!(
        rsass(
            "div {\n  span {\n    color: red;\n    background: blue;\n  }\n}\n\ndiv {\n  color: gray;\n  empty {\n    span {\n      color: red;\n      background: blue;\n    }\n  }\n}\n\nempty1 {\n  empty2 {\n    div {\n      blah: blah;\n    }\n  }\n}\n\nempty1 {\n  empty2 {\n    div {\n      bloo: blee;\n      empty3 {\n        span {\n          blah: blah;\n          blah: blah;\n        }\n      }\n    }\n  }\n}\n"
        )?,
...
#[test]
fn t06_nesting_and_comments() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t07_nested_simple_selector_groups() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t08_selector_combinators() -> Result<(), String> {
    assert_eq!(
        rsass(
            "a   +   b  >  c {\n  d e {\n    color: blue;\n    background: white;\n  }\n  color: red;\n  background: gray;\n}"
        )?,
...
#[test]
fn t09_selector_groups_and_combinators() -> Result<(), String> {
    assert_eq!(
        rsass(
            "a + b, c {\n  blah: blah;\n  bleh: bleh;\n  d e, f ~ g + h, > i {\n    bloo: bloo;\n    blee: blee;\n  }\n}"
        )?,
...
#[test]
fn t10_classes_and_ids() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t11_attribute_selectors() -> Result<(), String> {
    assert_eq!(
        rsass(
            "[hey  =  \'ho\'], a > b {\n  blah: blah;\n  c, [hoo *=    \"ha\" ] {\n    bloo: bloo;\n  }\n}"
        )?,
...
#[test]
fn t12_pseudo_classes_and_elements() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t13_back_references() -> Result<(), String> {
    assert_eq!(
        rsass(
            "hey, ho {\n  & > boo, foo &.goo {\n    bloo: bloo;\n  }\n  blah: blah;\n}"
        )?,
...
#[test]
fn t17_basic_mixins() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t18_mixin_scope() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t19_full_mixin_craziness() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t20_scoped_variables() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t21_one_builtin_function() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t22_colors_with_alpha() -> Result<(), String> {
    assert_eq!(
        rsass(
...
// Ignoring "23_basic_value_interpolation", tests with expected error not implemented yet.

/// From "sass-spec/spec/basic/23_basic_value_interpolation-4.0"
#[test]
fn t23_basic_value_interpolation_4_0() -> Result<(), String> {
    assert_eq!(
        rsass(
            "div {\n  a: hello#{world};\n  a: hello #{world};\n  b: 12#{3};\n  b: type-of(12#{3});\n  b: #{12 + 111};\n  b: type-of(#{12 + 111});\n}"
        )?,
...
#[test]
fn t24_namespace_properties() -> Result<(), String> {
    assert_eq!(
        rsass(
            "div {\n  a: {\n    p1: q;\n    b: {\n      p2: q;\n    }\n    p3: q;\n  }\n}\n\nfoo {\n  bar: baz {\n    bip: bop;\n    bing: type-of(\"hello\");\n    bang: 1 + 2;\n    bung: bap;\n    bong: bup {\n      x: x;\n      y: y;\n      z: z;\n    }\n  }\n}\n"
        )?,
...
#[test]
fn t25_basic_string_interpolation() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t26_selector_interpolation() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t27_media_queries() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t30_if_in_function() -> Result<(), String> {
    assert_eq!(
        rsass(
            "$x: true;\n\n@function foobar() {\n  @if $x {\n    $x: false !global;\n    @return foo;\n  }\n  @else {\n    $x: true !global;\n    @return bar;\n  }\n}\n\ndiv {\n  content: foobar();\n  content: foobar();\n  content: foobar();\n  content: foobar();\n  $x: false !global;\n  content: foobar();\n}\n"
        )?,
...
#[test]
fn t31_if_in_mixin() -> Result<(), String> {
    assert_eq!(
        rsass(
            "$x: true;\n\n@mixin foobar() {\n  @if $x {\n    $x: false !global;\n    content: foo;\n  }\n  @else {\n    $x: true !global;\n    content: bar;\n  }\n}\n\ndiv {\n  @include foobar();\n  @include foobar();\n  @include foobar();\n  $x: true !global;\n  @include foobar();\n}\n"
        )?,
...
#[test]
fn t32_percentages() -> Result<(), String> {
    assert_eq!(
        rsass(
            "div {\n  width: 10% + 20%;\n  height: 10% - 20%;\n  width: 10% + 10;\n  width: 10 + 10%;\n  height: 10% - 10;\n  height: 10 - 10%;\n  blah: (20% / 4%);\n  flah: 12 * 75%;\n  grah: 75% * 12;\n  // hwah: (24 / 8%);\n  nyah: (35% / 7);\n}"
        )?,
...
#[test]
fn t35_varargs_false() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t36_extra_commas_in_selectors() -> Result<(), String> {
    assert_eq!(
        rsass("div,, , span, ,, {\n  color: red;\n}")?,
        "div, span {\n  color: red;\n}\n"
    );
...
#[test]
fn t37_url_expressions() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t38_expressions_in_at_directives() -> Result<(), String> {
    assert_eq!(
        rsass(
            "$x: 1;\n$y: 2;\n\n@foo $x $y, hux {\n  bar {\n    whatever: whatever;\n  }\n}\n"
        )?,
...
#[test]
fn t39_dash_match_attribute_selector() -> Result<(), String> {
    assert_eq!(
...
#[test]
fn t40_pseudo_class_identifier_starting_with_n() -> Result<(), String> {
    assert_eq!(
        rsass("div:lang(nb) {\n  color: blue;\n}")?,
        "div:lang(nb) {\n  color: blue;\n}\n"
    );
...
#[test]
fn t41_slashy_urls() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t42_css_imports() -> Result<(), String> {
    assert_eq!(
        rsass(
            "div {\n  color: red;\n}\n\n@import \"hux\\ bux.css\";\n@import \"foo.css\";\n\nspan {\n  color: blue;\n}\n\n@import \"bar.css\";"
        )?,
...
#[test]
fn t43_str_length() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t44_bem_selectors() -> Result<(), String> {
    assert_eq!(
        rsass(
            "div {\n\n  &_foo {\n    blah: blah;\n  }\n  &--modifier {\n    blach: blah;\n  }\n  &hux {\n    blah: blah;\n  }\n  &div.foo#bar[hux] {\n    blah: blah;\n  }\n\n}"
        )?,
...
#[test]
fn t45_str_insert() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t46_str_index() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t48_case_conversion() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t49_interpolants_in_css_imports() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t50_wrapped_pseudo_selectors() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t51_trailing_commas_in_list() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t52_interchangeable_hyphens_underscores() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t53_escaped_quotes() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t54_adjacent_identifiers_with_hyphens() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t55_variable_exists() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t56_global_variable_exists() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t57_function_exists() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t58_mixin_exists() -> Result<(), String> {
    assert_eq!(
        rsass(
...
#[test]
fn t59_if_expression() -> Result<(), String> {
    assert_eq!(
        rsass(
...
// Ignoring "60_call", tests with expected error not implemented yet.
