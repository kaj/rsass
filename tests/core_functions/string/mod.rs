...
mod index {
    ...
    fn named() {
        assert_eq!(
            rsass("a {b: str-index($string: \"cde\", $substring: \"c\")}\n")
                .unwrap(),
            "a {\n  b: 1;\n}\n"
        );
    }
...
mod insert {
    ...
    mod index {
        ...
        mod negative {
            ...
            fn after_last() {
                assert_eq!(
                    rsass("a {b: str-insert(\"cde\", \"f\", -100)}\n")
                        .unwrap(),
                    "a {\n  b: \"fcde\";\n}\n"
                );
            }
...
mod length {
    ...
    fn multiple_characters() {
        assert_eq!(
            rsass("a {b: str-length(\"fblthp abatement\")}\n").unwrap(),
            "a {\n  b: 16;\n}\n"
        );
    }
    #[test]
    ...
    fn unquoted() {
        assert_eq!(
            rsass("a {b: str-length(loofamonster)}\n").unwrap(),
            "a {\n  b: 12;\n}\n"
        );
    }
}
...
mod slice {
    ...
    fn unquoted() {
        assert_eq!(
            rsass("a {b: str-slice(cdefgh, 3, 5)}\n").unwrap(),
            "a {\n  b: efg;\n}\n"
        );
    }
}
...
mod to_lower_case {
    ...
    fn alphabet() {
        assert_eq!(
            rsass("a {b: to-lower-case(\"ABCDEFGHIJKLMNOPQRSTUVQXYZ\")}\n")
                .unwrap(),
    ...
    fn named() {
        assert_eq!(
            rsass("a {b: to-lower-case($string: abcDEF)}\n").unwrap(),
            "a {\n  b: abcdef;\n}\n"
        );
    }
    #[test]
    ...
    fn number() {
        assert_eq!(
            rsass("a {b: to-lower-case(\"1234567890\")}\n").unwrap(),
            "a {\n  b: \"1234567890\";\n}\n"
        );
    }
    #[test]
    fn unquoted() {
        assert_eq!(
            rsass("a {b: to-lower-case(aBcDeF)}\n").unwrap(),
            "a {\n  b: abcdef;\n}\n"
        );
    }
}
...
mod to_upper_case {
    ...
    fn alphabet() {
        assert_eq!(
            rsass("a {b: to-upper-case(\"abcdefghijklmnopqrstuvqxyz\")}\n")
                .unwrap(),
            "a {\n  b: \"ABCDEFGHIJKLMNOPQRSTUVQXYZ\";\n}\n"
        );
    }
    ...
    fn named() {
        assert_eq!(
            rsass("a {b: to-upper-case($string: abcDEF)}\n").unwrap(),
            "a {\n  b: ABCDEF;\n}\n"
        );
    }
    #[test]
    ...
    fn number() {
        assert_eq!(
            rsass("a {b: to-upper-case(\"1234567890\")}\n").unwrap(),
            "a {\n  b: \"1234567890\";\n}\n"
        );
    }
    #[test]
    fn unquoted() {
        assert_eq!(
            rsass("a {b: to-upper-case(aBcDeF)}\n").unwrap(),
            "a {\n  b: ABCDEF;\n}\n"
        );
    }
}
