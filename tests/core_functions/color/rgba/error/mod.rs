//! Tests auto-converted from "sass-spec/spec/core_functions/color/rgba/error"
#[allow(unused)]
use super::rsass;
#[allow(unused)]
use rsass::set_precision;

// From "sass-spec/spec/core_functions/color/rgba/error/five_args.hrx"

// Ignoring "five_args", error tests are not supported yet.

// From "sass-spec/spec/core_functions/color/rgba/error/four_args.hrx"
mod four_args {
    #[allow(unused)]
    use super::rsass;
    mod alpha {
...
// From "sass-spec/spec/core_functions/color/rgba/error/one_arg.hrx"
mod one_arg {
    #[allow(unused)]
    use super::rsass;
    mod list {
...
// From "sass-spec/spec/core_functions/color/rgba/error/three_args.hrx"
mod three_args {
    #[allow(unused)]
    use super::rsass;
    mod blue {
...
// From "sass-spec/spec/core_functions/color/rgba/error/two_args.hrx"
mod two_args {
    #[allow(unused)]
    use super::rsass;
    mod alpha {
