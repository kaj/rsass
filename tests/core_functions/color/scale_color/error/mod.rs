//! Tests auto-converted from "sass-spec/spec/core_functions/color/scale_color/error"
#[allow(unused)]
use super::rsass;

// From "sass-spec/spec/core_functions/color/scale_color/error/args.hrx"
mod args {
    #[allow(unused)]
    use super::rsass;
...
// From "sass-spec/spec/core_functions/color/scale_color/error/bounds.hrx"
mod bounds {
    #[allow(unused)]
    use super::rsass;
    mod alpha {
