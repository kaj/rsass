...
fn named() {
    assert_eq!(
        rsass("a {b: selector-parse($selector: \"c\")}\n").unwrap(),
        "a {\n  b: c;\n}\n"
    );
}
...
mod structure {
    ...
    mod decomposed {
        ...
        mod complex {
            ...
            fn mixed() {
                assert_eq!(
                    rsass("a {b: selector-parse(c \"d\" e)}\n").unwrap(),
                    "a {\n  b: c d e;\n}\n"
                );
            }
            #[test]
        ...
        mod full {
            ...
            fn mixed() {
                assert_eq!(
                    rsass("a {b: selector-parse((c \"d\", e \"f\"))}\n")
                        .unwrap(),
                    "a {\n  b: c d, e f;\n}\n"
                );
            }
        ...
        mod middle {
            ...
            fn unquoted() {
                assert_eq!(
                    rsass("a {b: selector-parse(c unquote(\"d, e\") f)}\n")
                        .unwrap(),
                    "a {\n  b: c d, e f;\n}\n"
                );
            }
        ...
        mod partial {
            ...
            fn mixed() {
                assert_eq!(
                    rsass("a {b: selector-parse((c d, unquote(\"e f\")))}\n")
                        .unwrap(),
                    "a {\n  b: c d, e f;\n}\n"
                );
            }
    ...
    mod full_string {
        ...
        fn unquoted() {
            assert_eq!(
                rsass("a {b: selector-parse(unquote(\"c d, e f\"))}\n")
                    .unwrap(),
                "a {\n  b: c d, e f;\n}\n"
            );
        }
