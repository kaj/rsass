//! Tests auto-converted from "sass-spec/spec/values/calculation/calc/error/known_incompatible/length/rem.hrx"
...
fn dpcm() {
    assert_eq!(
        runner().err("a {b: calc(1rem + 1dpcm)}\n"),
...
fn dppx() {
    assert_eq!(
        runner().err("a {b: calc(1rem + 1dppx)}\n"),
...
fn grad() {
    assert_eq!(
        runner().err("a {b: calc(1rem + 1grad)}\n"),
...
fn turn() {
    assert_eq!(
        runner().err("a {b: calc(1rem + 1turn)}\n"),
