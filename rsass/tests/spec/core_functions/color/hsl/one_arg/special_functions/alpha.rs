...
mod calc {
    ...
    mod string {
        ...
        fn arg_1() {
            assert_eq!(
                runner().ok("a {b: hsl(unquote(\"calc(1)\") 2% 3% / 0.4)}\n"),
                "a {\
        ...
        fn arg_2() {
            assert_eq!(
                runner().ok("a {b: hsl(1 unquote(\"calc(2%)\") 3% / 0.4)}\n"),
                "a {\
        ...
        fn arg_3() {
            assert_eq!(
                runner().ok("a {b: hsl(1 2% unquote(\"calc(3%)\") / 0.4)}\n"),
                "a {\
        ...
        fn arg_4() {
            assert_eq!(
                runner().ok("a {b: hsl(1 2% 3% / unquote(\"calc(0.4)\"))}\n"),
                "a {\
