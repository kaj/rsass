//! Tests auto-converted from "sass-spec/spec/core_functions/color/hsl/three_args/w3c/black_to_white_through.hrx"

fn runner() -> crate::TestRunner {
    super::runner().with_cwd("black_to_white_through")
}
